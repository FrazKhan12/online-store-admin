...
const AddNewRole = () => {
  ...
  const handleAddRole = async (data) => {
    try {
      ...
      dispatch(showLoader());
      const res = await createAdminRole(roleData);
      dispatch(hideLoader());
      if (res?.data) {
  ...
  return (
    <>
      <div className="mt-[100px]">
        <Form layout="vertical" onFinish={handleAddRole}>
            ...
            <Row>
              ...
              <Col className="flex gap-5" span={10}>
                <Checkbox
                  ...
                  onChange={(e) => {
                    onChangeCheckbox(e.target.name, !permissions.viewProducts);
                  }}
                  name="viewProducts"
                >
                  View
                ...
                <Checkbox
                  ...
                  onChange={(e) => {
                    onChangeCheckbox(e.target.name, !permissions.editProducts);
                  }}
                  name="editProducts"
                >
                  Edit
            ...
            <Row>
              ...
              <Col className="flex gap-5" span={10}>
                <Checkbox
                  ...
                  onChange={(e) => {
                    onChangeCheckbox(e.target.name, !permissions.viewCategory);
                  }}
                  name="viewCategory"
                >
                  View
                ...
                <Checkbox
                  ...
                  onChange={(e) => {
                    onChangeCheckbox(e.target.name, !permissions.editCategory);
                  }}
                  name="editCategory"
                >
                  Edit
